...
const ParallaxHeader = () => {
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="Bertazzoni Appliance Repair in Los Angeles and Nearby Areas">Bertazzoni Appliance Repair<br/> <span className="h1-location">
  ...
  decoding="async"/>
    <p>
  Trained technicians providing expert Bertazzoni appliance repair for ranges, ovens, cooktops, dishwashers, refrigerators, wine coolers, and range hoods throughout Los Angeles and surrounding service areas.
</p>
