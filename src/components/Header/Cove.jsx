  ...
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="Cove Appliance Repair">Cove Appliance Repair in Los Angeles & Nearby Areas</h1>
        <img className="header-image" width="1200" height="630" src="/cove/cove-dishwasher-repair-los-angeles-and-nearby-areas.webp" alt="Cove Appliance Repair Services Los Angeles and Nearby Areas"  fetchpriority="high"
  decoding="async"/>
    <p>
