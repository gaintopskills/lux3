...
const ParallaxHeader = () => {
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="Cove Dishwasher Repair">Cove Dishwasher Repair<br/> <span className="h1-location">
  ...
  decoding="async"/>
    <p>
    Trained technicians providing expert Cove dishwasher repair throughout Los Angeles and surrounding service areas.
</p>
