...
const ParallaxHeader = () => {
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="AGA Appliance Repair">AGA Appliance Repair<br/> <span className="h1-location">
  ...
  decoding="async"/>
<p>Experienced technicians specializing in luxury AGA appliance repair. We are experts in fixing ranges, range cookers, rangetops, ovens, and hoods.</p>        
