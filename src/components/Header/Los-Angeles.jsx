...
const ParallaxHeader = () => {
  ...
  decoding="async"/>
       <p>
          Professional repair for luxury and high-end appliances in Los Angeles, including Sub-Zero, Wolf, Viking, Thermador, Miele, Bosch, Cove, and other premium brands.
        </p>
