...
const ParallaxHeader = () => {
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="SUB-ZERO">High-End & Luxury Appliance Repair Bel Air<br/></h1>
  ...
  decoding="async"/>
        <p>
  Professional high-end appliance repair in Bel Air for luxury built-in refrigerators, ranges, ovens, cooktops, dishwashers, wine coolers, laundry appliances, and outdoor kitchen systems. We service Sub-Zero, Wolf, Thermador, Miele, Viking, Gaggenau, La Cornue, Lacanche, Monogram, Dacor, Fisher & Paykel, Bertazzoni, True Residential, JennAir, Bosch, Kalamazoo, Lynx, Hestan, DCS, Alfresco, Twin Eagles, Fire Magic, and other premium appliance brands.
</p>
