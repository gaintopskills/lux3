  ...
  return (
    <div className="video-container">
      ...
      <div className="maintext">
        <h1 class="gold-embossed" data-text="SUB-ZERO">Sub-Zero Repair Malibu</h1>
        <img className="header-image" width="400" height="210" src="/sub-zero/sub-zero-repair-services-malibu.webp" alt="Sub-Zero Repair Services"/>
        <p>
