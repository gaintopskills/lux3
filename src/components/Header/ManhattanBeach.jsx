    ...
    <div className="video-container">
      ...
      <div className="maintext">
        ...
        <img
          ...
          alt="High-end and luxury appliance repair in Manhattan Beach"
          fetchPriority="high"
          decoding="async"
        />

        <p>
          Professional high-end appliance repair in Manhattan Beach for luxury
          ...
          premium appliances in oceanfront homes, coastal residences, modern
          custom homes, luxury condos, and designer kitchens throughout
          Manhattan Beach and nearby areas. Our technicians work with Sub-Zero,
