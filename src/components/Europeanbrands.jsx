  ...
  useEffect(() => {
    ...
    const updateParallax = () => {
      ...
      if (heroBgRef.current) {
        heroBgRef.current.style.transform = `translateY(${scrollY * 0.5}px) scale(1.08)`;
      }

      if (secondBgRef.current && secondSectionRef.current) {
        const rect = secondSectionRef.current.getBoundingClientRect();
        const localOffset = Math.max(0, -rect.top);

        secondBgRef.current.style.transform = `translateY(${localOffset * 0.28}px) scale(1.08)`;
      }
  ...
  return (
    <section className="european-luxury-landing">
      <div className="european-luxury-page">
        <div className="european-luxury-main">
          ...
          >
            <div
              ref={secondBgRef}
              className="european-luxury-second-bg"
            />

            <div className="european-luxury-content-overlay" />
        ...
        <aside className="european-luxury-sidebar">
          <div className="european-luxury-form-card desktop-form sticky-form" id="request-service">
            <h2>Request Service Now</h2>
