...
export const MegaMenu = () => {
  ...
  const brandsColumns = [
    [
      {type: "heading", label: "European", href: "/european-appliance-repair/", },
      ...
      {type: "heading", label: "Pro-Style", href: "/pro-style-appliance-repair/", },
    ...
    { label: "JennAir", href: "/jennair-appliance-repair/" },
      ...
      { label: "Twin Eagles", href: "/twin-eagles-repair/" },
      { label: "Fire Magic", href: "/fire-magic-repair/" },
      ...
      <nav className="navbar">
        <div className="first-row">
          <a className="logo logo-desktop" href="/">
            <img width="140" height="37" alt="Logo" src="/logo5.png" />
          </a>
