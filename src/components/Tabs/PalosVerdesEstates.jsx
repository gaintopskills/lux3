  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Palos Verdes Estates",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Palos Verdes Estates</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Palos Verdes Estates homes
            often feature custom kitchens, coastal bluff residences, estate homes,
            ocean-view properties, stone countertops, premium ventilation, and
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Palos Verdes Estates",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Palos Verdes Estates</strong> for wall ovens,
            ...
            Palos Verdes Estates homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Palos Verdes Estates",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Palos Verdes Estates</strong>{" "}
            ...
            Palos Verdes Estates kitchens are often designed with stone countertops, custom
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Palos Verdes Estates",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Palos Verdes Estates</strong> for
            ...
            is especially important in Palos Verdes Estates kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Palos Verdes Estates",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Palos Verdes Estates</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Palos Verdes Estates homes feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in Palos Verdes Estates",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Palos Verdes Estates</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Palos Verdes Estates",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Palos Verdes Estates</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Palos Verdes Estates",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Palos Verdes Estates</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Palos Verdes Estates kitchens, home bars,
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Palos Verdes Estates",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Palos Verdes Estates</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Palos Verdes Estates",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Palos Verdes Estates</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Palos Verdes Estates",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Palos Verdes Estates</strong> for
            ...
            dishwashers in Palos Verdes Estates kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Palos Verdes Estates",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Palos Verdes Estates</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Palos Verdes Estates",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Palos Verdes Estates</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Palos Verdes Estates",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Palos Verdes Estates</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Palos Verdes Estates",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Palos Verdes Estates</strong> for built-in
            ...
            appliances. Many Palos Verdes Estates homes include patios, terraces, poolside
            entertaining spaces, coastal bluff properties, and built-in grilling stations
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Palos Verdes Estates",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Palos Verdes Estates</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Palos Verdes Estates",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Palos Verdes Estates",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Palos Verdes Estates</strong> for
            ...
            premium backyard cooking systems. Palos Verdes Estates outdoor kitchens are often
            designed for patios, terraces, pool areas, coastal bluff properties, family
