    ...
    const items = [
      {
        id: "range",
        title: "Range Repair",
        heading: "Range Repair in Thousand Oaks",
        img: "/cities/range-repair.webp",
        alt: "Range repair in Thousand Oaks",
        description: (
          <>
            <p>
              Luxury Appliance Repair by Zaricci provides professional{" "}
              <strong>range repair in Thousand Oaks</strong> for gas ranges, dual-fuel
              ranges, electric ranges, induction ranges, European ranges, retro
              ranges, and professional-style cooking appliances. Thousand Oaks homes
              often feature custom kitchens, suburban estates, hillside residences,
              gated communities, stone countertops, premium ventilation, and
    ...
    
      {
        id: "oven",
        title: "Oven Repair",
        heading: "Oven Repair in Thousand Oaks",
        img: "/cities/oven-repair.webp",
        alt: "Oven repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>oven repair in Thousand Oaks</strong> for wall ovens,
              ...
              Thousand Oaks homes, ovens are often integrated into custom cabinetry or
    ...
    
      {
        ...
        heading: "Cooktop Repair in Thousand Oaks",
        img: "/cities/cooktop-repair.webp",
        alt: "Cooktop repair in Thousand Oaks",
        description: (
          <>
            <p>
              Our technicians provide <strong>cooktop repair in Thousand Oaks</strong>{" "}
              ...
              Thousand Oaks kitchens are often designed with stone countertops, custom
              islands, flush-mounted surfaces, and open-concept layouts that connect
              indoor cooking spaces with patios, terraces, and backyard entertaining areas. We repair cooktops with
    ...
    
      {
        ...
        heading: "Ventilation & Range Hood Repair in Thousand Oaks",
        img: "/cities/range-hood-repair.webp",
        alt: "Ventilation and range hood repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>range hood repair in Thousand Oaks</strong> for
              ...
              is especially important in Thousand Oaks kitchens with powerful gas
            ...
            <ul>
              ...
              <li>
                ...
                {/* restrictions, grease buildup, and airflow ,/,//s that reduce */}
    ...
    
      {
        ...
        heading: "Refrigerator Repair in Thousand Oaks",
        img: "/cities/refrigerator-repair.webp",
        alt: "Refrigerator repair in Thousand Oaks",
        description: (
          <>
            <p>
              Luxury Appliance Repair by Zaricci provides{" "}
              <strong>refrigerator repair in Thousand Oaks</strong> for built-in,
              panel-ready, integrated, column, French door, bottom freezer,
              side-by-side, and high-end residential refrigeration systems. Many
              Thousand Oaks homes feature refrigerators built into custom cabinetry or
    ...
    
      {
        ...
        heading: "Freezer Repair in Thousand Oaks",
        img: "/cities/freezer-repair.webp",
        alt: "Freezer repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>freezer repair in Thousand Oaks</strong> for built-in
    ...
    
      {
        ...
        heading: "Beverage Center Repair in Thousand Oaks",
        img: "/cities/beverage-center-repair.webp",
        alt: "Beverage center repair in Thousand Oaks",
        description: (
          <>
            <p>
              We repair <strong>beverage centers in Thousand Oaks</strong> for kitchens,
    ...
    
      {
        ...
        heading: "Ice Maker Repair in Thousand Oaks",
        img: "/cities/ice-maker-repair.webp",
        alt: "Ice maker repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>ice maker repair in Thousand Oaks</strong> for built-in
              ice machines, undercounter ice makers, panel-ready ice machines, and
              refrigerator ice maker systems. In Thousand Oaks kitchens, home bars,
    ...
    
      {
        id: "dryer",
        title: "Dryer Repair",
        heading: "Dryer Repair in Thousand Oaks",
        img: "/cities/dryer-repair.webp",
        alt: "Dryer repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>dryer repair in Thousand Oaks</strong> for vented
    ...
    
      {
        ...
        heading: "Washing Machine Repair in Thousand Oaks",
        img: "/cities/washing-machine-repair.webp",
        alt: "Washing machine repair in Thousand Oaks",
        description: (
          <>
            <p>
              Our technicians provide{" "}
              <strong>washing machine repair in Thousand Oaks</strong> for front-load
    ...
    
      {
        ...
        heading: "Dishwasher Repair in Thousand Oaks",
        img: "/cities/dishwasher-repair.webp",
        alt: "Dishwasher repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>dishwasher repair in Thousand Oaks</strong> for
              ...
              dishwashers in Thousand Oaks kitchens are hidden behind custom cabinetry,
    ...
    
      {
        ...
        heading: "Warming Drawer Repair in Thousand Oaks",
        img: "/cities/warming-drawer-repair.webp",
        alt: "Warming drawer repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>warming drawer repair in Thousand Oaks</strong> for
    ...
    
      {
        ...
        heading: "Wine Cooler Repair in Thousand Oaks",
        img: "/cities/wine-cooler-repair.webp",
        alt: "Wine cooler repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>wine cooler repair in Thousand Oaks</strong> for
    ...
    
      {
        ...
        heading: "Wine Storage & Preservation System Repair in Thousand Oaks",
        img: "/cities/wine-cellar-repair.webp",
        alt: "Wine storage and preservation system repair in Thousand Oaks",
        description: (
          <>
            <p>
              We service{" "}
              <strong>wine storage and preservation systems in Thousand Oaks</strong> for
    ...
    
      {
        ...
        heading: "BBQ Grill Repair in Thousand Oaks",
        img: "/cities/bbq-grill-repair.webp",
        alt: "BBQ grill repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>BBQ grill repair in Thousand Oaks</strong> for built-in
              ...
              appliances. Many Thousand Oaks homes include patios, terraces, poolside
    ...
    
      {
        ...
        heading: "Pizza Oven Repair in Thousand Oaks",
        img: "/cities/pizza-oven-repair.webp",
        alt: "Pizza oven repair in Thousand Oaks",
        description: (
          <>
            <p>
              We service <strong>pizza ovens in Thousand Oaks</strong> for indoor
    ...
    
      {
        ...
        heading: "Outdoor Kitchen Repair in Thousand Oaks",
        img: "/cities/outdoor-kitchen-repair.webp",
        alt: "Outdoor kitchen appliance repair in Thousand Oaks",
        description: (
          <>
            <p>
              We provide <strong>outdoor kitchen repair in Thousand Oaks</strong> for
              ...
              premium backyard cooking systems. Thousand Oaks outdoor kitchens are often
