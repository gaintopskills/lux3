  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Santa Monica",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Santa Monica",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Santa Monica</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Santa Monica homes
            often feature custom kitchens, coastal residences, luxury condos,
            stone countertops, premium ventilation, and built-in appliance suites, so we
            approach every range repair with attention to safety, performance, and the
          ...
          <p>
            <strong>
              AGA, Bertazzoni, Fulgor Milano, Gaggenau, ILVE, Lacanche, La
              Cornue, Miele, Officine Gullo, American Range, BlueStar, FiveStar,
              Thor, Forno, Garland, ZLINE, Wolf, Thermador, Viking, Monogram,
              Signature Kitchen Suite, Hestan, Dacor, Fisher & Paykel, Smeg, Big
              Chill, Elmira Stove Works, Heartland, Bosch, and JennAir.
            </strong>
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Temperature calibration:</strong> We verify oven
              temperature, heat recovery, cycling behavior, and sensor accuracy so
              the range performs properly for baking, roasting, and high-heat
              cooking.
            </li>
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Santa Monica",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Santa Monica</strong> for wall ovens,
            ...
            Santa Monica homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Santa Monica",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Santa Monica",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Santa Monica</strong>{" "}
            ...
            Santa Monica kitchens are often designed with stone countertops, custom
            islands, flush-mounted surfaces, and carefully integrated layouts in coastal
            residences, luxury condos, and renovated homes. We repair cooktops with care
            for both performance and surrounding finishes.
          </p>
          ...
          <p>
            <strong>
              AGA, Bertazzoni, Fulgor Milano, Gaggenau, ILVE, Lacanche, La
              Cornue, Miele, Officine Gullo, American Range, BlueStar, Thor, Forno,
              Garland, ZLINE, Wolf, Thermador, Viking, Monogram, Signature Kitchen
              Suite, Hestan, Dacor, Fisher & Paykel, Bosch, JennAir, and Smeg.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Santa Monica",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Santa Monica</strong> for
            ...
            is especially important in Santa Monica kitchens with powerful gas
          ...
          <p>
            <strong>
              Bertazzoni, Fulgor Milano, Gaggenau, ILVE, Lacanche, La Cornue,
              Miele, Officine Gullo, American Range, BlueStar, Thor, Forno,
              Garland, ZLINE, Wolf, Thermador, Viking, Monogram, Hestan, Dacor,
              Fisher & Paykel, Bosch, JennAir, Smeg, Kalamazoo, Lynx, Hestan
              Outdoor, Viking Outdoor, DCS, Alfresco, Twin Eagles, Fire Magic,
              Wolf Outdoors, True Residential Outdoor, and Caliber.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Santa Monica",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Santa Monica",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Santa Monica</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Santa Monica homes and luxury condos often feature refrigerators built into
            custom cabinetry or concealed behind matching panels. We repair these systems
            carefully while protecting surrounding millwork, floors, and kitchen finishes.
          </p>
          ...
          <p>
            <strong>
              AGA, Bertazzoni, Fulgor Milano, Gaggenau, Liebherr, Miele,
              Sub-Zero, Fisher & Paykel, Thermador, True Residential, Viking,
              Monogram, Signature Kitchen Suite, Dacor, Forno, Thor, Smeg, Big
              Chill, Elmira Stove Works, Heartland, Bosch, and JennAir.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Freezer Repair in Santa Monica",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Santa Monica</strong> for built-in
          ...
          <p>
            <strong>
              Bertazzoni, Fulgor Milano, Gaggenau, Liebherr, Miele, Sub-Zero,
              Fisher & Paykel, Thermador, True Residential, Viking, Monogram,
              Signature Kitchen Suite, Dacor, Forno, Smeg, Bosch, and JennAir.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Santa Monica",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Santa Monica",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Santa Monica</strong> for kitchens,
            home bars, entertainment rooms, guest spaces, patios, rooftop areas,
          ...
          <p>
            <strong>
              Sub-Zero, True Residential, Monogram, JennAir, Miele, Fisher &
              Paykel, Viking, Thermador, Dacor, Gaggenau, Liebherr, Bosch,
              Bertazzoni, Fulgor Milano, Signature Kitchen Suite, and Smeg.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Santa Monica",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Santa Monica</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Santa Monica kitchens, home bars,
            patios, rooftop entertaining areas, and guest spaces, reliable ice
          ...
          <p>
            <strong>
              Sub-Zero, Monogram, Viking, True Residential, Thermador, Fisher &
              Paykel, JennAir, Signature Kitchen Suite, Dacor, Bosch, Miele,
              Gaggenau, Liebherr, Bertazzoni, Fulgor Milano, Forno, and Thor.
            </strong>
          </p>
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Santa Monica",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Santa Monica</strong> for vented
            ...
            stacked configurations, so airflow, access, leak prevention, and quiet
            operation matter.
          </p>
          ...
          <p>
            <strong>
              Miele, Bosch, Fisher & Paykel, and Asko.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Santa Monica",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Santa Monica",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Santa Monica</strong> for front-load
            ...
            residences where quiet operation, vibration control, and leak prevention
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Santa Monica",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Santa Monica</strong> for
            ...
            dishwashers in Santa Monica kitchens are hidden behind custom cabinetry,
          ...
          <p>
            <strong>
              AGA, Bertazzoni, Fulgor Milano, Gaggenau, ILVE, Miele, Forno,
              Thor, ZLINE, Cove, Fisher & Paykel, Thermador, Viking, Monogram,
              Signature Kitchen Suite, Dacor, Smeg, Asko, Bosch, and JennAir.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Santa Monica",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Santa Monica</strong> for
          ...
          <p>
            <strong>
              AGA, Bertazzoni, Fulgor Milano, Gaggenau, ILVE, Miele, Fisher &
              Paykel, Wolf, Thermador, Viking, Monogram, Hestan, Dacor, Bosch,
              and JennAir.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Santa Monica",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Santa Monica</strong> for
          ...
          <p>
            <strong>
              Bertazzoni, Fulgor Milano, Gaggenau, Liebherr, Miele, Sub-Zero,
              Fisher & Paykel, Thermador, True Residential, Viking, Monogram,
              Signature Kitchen Suite, Dacor, Smeg, Bosch, and JennAir.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Santa Monica",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Santa Monica",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Santa Monica</strong> for
          ...
          <h3>Common Wine Storage System Problems We Service</h3>
          ...
          <h3>Wine Storage Brands We Service</h3>
  
          <p>
            <strong>
              Sub-Zero, True Residential, Liebherr, Miele, Gaggenau, Monogram,
              Thermador, Dacor, Fisher & Paykel, Signature Kitchen Suite,
              Bertazzoni, Fulgor Milano, Smeg, Bosch, and JennAir wine storage and
              preservation systems.
            </strong>
          </p>
  
          <h3>How We Diagnose Wine Storage Systems</h3>
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Santa Monica",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Santa Monica</strong> for built-in
            ...
            appliances. Santa Monica properties may include patios, rooftop decks,
            terraces, balconies, and built-in grilling stations that require reliable
            ignition, even heat, and safe gas performance. Outdoor components may also
            need closer inspection for moisture exposure, salt air, corrosion, and
          ...
          <p>
            <strong>
              Kalamazoo, Lynx, Hestan Outdoor, Viking Outdoor, DCS, Alfresco,
              Twin Eagles, Fire Magic, Wolf Outdoors, True Residential Outdoor,
              and Caliber.
            </strong>
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, grease buildup, weather exposure, salt-air damage,
              moisture-related wear, and maintenance needs.
            </li>
          </ul>
        </>
      ),
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Santa Monica",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Santa Monica",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Santa Monica</strong> for indoor
          ...
          <p>
            <strong>
              Kalamazoo, Lynx, Hestan Outdoor, Viking Outdoor, DCS, Alfresco,
              Twin Eagles, Fire Magic, Wolf Outdoors, and Caliber outdoor-kitchen
              systems where a supported pizza oven or high-heat cooking appliance
              is installed.
            </strong>
          </p>
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Santa Monica",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Santa Monica",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Santa Monica</strong> for
            ...
            premium outdoor cooking systems. Santa Monica outdoor kitchens are often
            designed for patios, rooftop areas, terraces, balconies, family gatherings,
            and indoor-outdoor entertaining spaces. Reliable appliance performance,
            careful service, and inspection for moisture, salt air, corrosion, and
            weather-related wear all matter.
          </p>
          ...
          <p>
            <strong>
              Kalamazoo, Lynx, Hestan Outdoor, Viking Outdoor, DCS, Alfresco,
              Twin Eagles, Fire Magic, Wolf Outdoors, True Residential Outdoor,
              Caliber, Fisher & Paykel, and Sub-Zero.
            </strong>
          </p>
