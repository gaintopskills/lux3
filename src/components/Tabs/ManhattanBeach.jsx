  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Manhattan Beach",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Manhattan Beach",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Manhattan Beach</strong> for gas ranges,
            dual-fuel ranges, electric ranges, induction ranges, European ranges,
            retro ranges, and professional-style cooking appliances. Manhattan
            Beach homes often feature coastal kitchens, custom cabinetry, stone
            countertops, open-concept layouts, designer finishes, and premium
            cooking appliances, so we approach every range repair with attention to
            safety, performance, and the surrounding kitchen design.
          </p>
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Manhattan Beach",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Manhattan Beach</strong> for wall
            ...
            ranges. Manhattan Beach kitchens often include custom appliance walls,
            modern coastal layouts, designer cabinetry, stone surfaces, and
            high-end appliance suites, so careful diagnosis and clean service are
            essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in Manhattan Beach",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Manhattan Beach",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>cooktop repair in Manhattan Beach</strong> for gas cooktops,
            electric cooktops, induction cooktops, rangetops, modular cooktops,
            and high-end built-in cooking surfaces. Cooktops in Manhattan Beach
            homes are often installed into stone countertops, custom kitchen
            islands, coastal remodels, open-concept kitchens, and designer cooking
            spaces, so we repair them with care for both performance and
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Manhattan Beach",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Manhattan Beach</strong> for
            ...
            is especially important in coastal homes, open-concept kitchens,
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Manhattan Beach",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Manhattan Beach",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Manhattan Beach</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Manhattan Beach kitchens feature custom cabinetry, concealed appliance
            panels, coastal layouts, built-in refrigeration columns, wine storage,
  ...
  
    {
      ...
      heading: "Freezer Repair in Manhattan Beach",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Manhattan Beach</strong> for
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Manhattan Beach",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Manhattan Beach",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Manhattan Beach</strong> for
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Manhattan Beach",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Manhattan Beach</strong> for
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Manhattan Beach",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Manhattan Beach</strong> for vented
            dryers, ventless dryers, heat pump dryers, condenser dryers, stacked
            laundry systems, and premium laundry appliances. Dryers in Manhattan
            Beach homes may be installed in laundry rooms, utility rooms, guest
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Manhattan Beach",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Manhattan Beach",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Manhattan Beach</strong> for
            ...
            coastal homes, laundry rooms, utility rooms, guest spaces, closets, and
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Manhattan Beach",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Manhattan Beach</strong> for
            ...
            Manhattan Beach homes are installed behind custom panels, within open
            kitchens, butler-style areas, guest spaces, or entertaining areas, so
            we service them carefully without disturbing the surrounding cabinetry.
          </p>
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Manhattan Beach",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Manhattan Beach</strong>{" "}
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Manhattan Beach",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Manhattan Beach</strong> for
            ...
            sealing, especially in coastal homes where humidity and installation
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Manhattan Beach",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Manhattan Beach",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Manhattan Beach</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, coastal homes, private tasting areas, and home collections. A
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Manhattan Beach",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Manhattan Beach</strong> for
            ...
            cooking appliances. In Manhattan Beach homes, grill systems may be
            located in outdoor kitchens, patios, rooftop decks, beach-adjacent
            entertaining spaces, courtyards, and custom outdoor living areas where
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Manhattan Beach",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Manhattan Beach",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Manhattan Beach</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Manhattan Beach",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Manhattan Beach",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Manhattan Beach</strong>{" "}
            for built-in grills, outdoor refrigerators, beverage centers, ice
            makers, warming drawers, pizza ovens, side burners, outdoor
            ventilation, and premium outdoor cooking systems. Manhattan Beach
            outdoor kitchens may be part of beach-adjacent patios, rooftop decks,
            courtyards, outdoor dining spaces, pool areas, and custom coastal
            living areas, so reliable appliance performance and careful service
            matter.
          </p>
