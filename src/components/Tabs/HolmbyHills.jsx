  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Holmby Hills",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Holmby Hills",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Holmby Hills</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Holmby Hills homes
            often feature estate kitchens, custom cabinetry, stone countertops,
            designer finishes, secondary kitchens, and high-performance cooking
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Holmby Hills",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Holmby Hills</strong> for wall ovens,
            double ovens, steam ovens, speed ovens, convection ovens, French-door
            ovens, built-in ovens, and oven sections inside premium ranges. Holmby
            Hills kitchens often include built-in appliance walls, custom millwork,
            oversized cooking spaces, chef-style layouts, and high-end appliance
  ...
  
    {
      ...
      heading: "Cooktop Repair in Holmby Hills",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Holmby Hills",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Holmby Hills</strong>{" "}
            ...
            Holmby Hills homes are often installed into stone countertops, custom
            islands, flush-mounted surfaces, butler’s pantries, and designer
            kitchens, so we repair them with care for both performance and
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Holmby Hills",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Holmby Hills</strong> for
            ...
            is especially important in estate kitchens, open-concept spaces, chef
            kitchens, and outdoor-adjacent cooking areas where smoke, cooking
            odors, grease, and airflow problems need to be controlled efficiently.
          </p>
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Holmby Hills",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Holmby Hills",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Holmby Hills</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Holmby Hills kitchens feature refrigerators built into custom cabinetry,
            concealed behind matching panels, or paired with freezer columns, wine
            storage, and beverage refrigeration, so we repair them carefully while
  ...
  
    {
      ...
      heading: "Freezer Repair in Holmby Hills",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Holmby Hills</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Holmby Hills",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Holmby Hills",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Holmby Hills</strong> for
            kitchens, home bars, media rooms, entertainment spaces, guest houses,
            pool houses, undercounter installations, and custom cabinetry
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Holmby Hills",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Holmby Hills</strong> for
            ...
            pool houses, outdoor entertaining areas, guest houses, and estate
            entertainment spaces, clear ice production, proper drainage, and quiet
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Holmby Hills",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Holmby Hills</strong> for vented
            dryers, ventless dryers, heat pump dryers, condenser dryers, stacked
            laundry systems, and premium laundry appliances. Dryers in Holmby Hills
            homes may be installed in laundry rooms, utility rooms, guest houses,
            staff areas, closets, or stacked configurations, so airflow, access,
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Holmby Hills",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Holmby Hills",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Holmby Hills</strong> for front-load
            washers, top-load washers, compact washers, stacked laundry systems,
            and premium laundry appliances. We service laundry systems in estate
            laundry rooms, utility rooms, guest houses, staff areas, closets, and
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Holmby Hills",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Holmby Hills</strong> for
            ...
            Holmby Hills homes are installed behind custom panels, within large
            estate kitchens, butler’s pantries, guest kitchens, or entertaining
            areas, so we service them carefully without disturbing the surrounding
            cabinetry.
          </p>
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Holmby Hills",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Holmby Hills</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Holmby Hills",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Holmby Hills</strong> for
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Holmby Hills",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Holmby Hills",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Holmby Hills</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, estate wine cellars, private tasting rooms, and home
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Holmby Hills",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Holmby Hills</strong> for
            ...
            cooking appliances. In Holmby Hills homes, grill systems may be located
            in outdoor kitchens, pool areas, patios, guest house spaces, terraces,
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Holmby Hills",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Holmby Hills",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Holmby Hills</strong> for indoor
            gourmet kitchens, outdoor kitchens, built-in cooking areas, patios,
            poolside kitchens, terraces, guest house kitchens, and entertainment
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Holmby Hills",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Holmby Hills",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Holmby Hills</strong> for
            ...
            premium outdoor cooking systems. Holmby Hills outdoor kitchens may be
            part of pool areas, patios, terraces, guest houses, estate entertaining
            spaces, and custom outdoor living areas, so reliable appliance
