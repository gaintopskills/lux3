  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Rancho Palos Verdes",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Rancho Palos Verdes</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Rancho Palos Verdes homes
            often feature custom kitchens, hillside residences, coastal bluff homes,
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Rancho Palos Verdes",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Rancho Palos Verdes</strong> for wall ovens,
            ...
            Rancho Palos Verdes homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Rancho Palos Verdes",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Rancho Palos Verdes</strong>{" "}
            ...
            Rancho Palos Verdes kitchens are often designed with stone countertops, custom
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Rancho Palos Verdes",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Rancho Palos Verdes</strong> for
            ...
            is especially important in Rancho Palos Verdes kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Rancho Palos Verdes",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Rancho Palos Verdes</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Rancho Palos Verdes homes feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in Rancho Palos Verdes",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Rancho Palos Verdes</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Rancho Palos Verdes",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Rancho Palos Verdes</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Rancho Palos Verdes",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Rancho Palos Verdes</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Rancho Palos Verdes kitchens, home bars,
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Rancho Palos Verdes",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Rancho Palos Verdes</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Rancho Palos Verdes",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Rancho Palos Verdes</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Rancho Palos Verdes",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Rancho Palos Verdes</strong> for
            ...
            dishwashers in Rancho Palos Verdes kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Rancho Palos Verdes",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Rancho Palos Verdes</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Rancho Palos Verdes",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Rancho Palos Verdes</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Rancho Palos Verdes",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Rancho Palos Verdes</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Rancho Palos Verdes",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Rancho Palos Verdes</strong> for built-in
            ...
            appliances. Many Rancho Palos Verdes homes include patios, terraces, poolside
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Rancho Palos Verdes",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Rancho Palos Verdes</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Rancho Palos Verdes",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Rancho Palos Verdes",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Rancho Palos Verdes</strong> for
            ...
            premium backyard cooking systems. Rancho Palos Verdes outdoor kitchens are often
            designed for patios, terraces, pool areas, ocean-view properties, family
