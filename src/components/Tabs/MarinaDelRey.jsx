  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Marina Del Rey",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Marina Del Rey",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Marina Del Rey</strong> for gas ranges,
            dual-fuel ranges, electric ranges, induction ranges, European ranges,
            retro ranges, and professional-style cooking appliances. Marina Del Rey homes, waterfront condos, marina-adjacent residences, and
            luxury apartments often feature compact designer kitchens, custom
            cabinetry, stone countertops, open-concept layouts, and premium
            cooking appliances, so we approach every range repair with attention to
            safety, performance, access, and the surrounding kitchen design.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              cabinetry, stone countertops, designer floors, coastal home layouts,
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Marina Del Rey",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Marina Del Rey</strong> for wall
            ovens, double ovens, steam ovens, speed ovens, convection ovens,
            French-door ovens, built-in ovens, and oven sections inside premium
            ranges. Marina Del Rey kitchens often include custom appliance walls,
            modern coastal layouts, designer cabinetry, stone surfaces, compact
            luxury layouts, and high-end appliance suites, so careful diagnosis and
  ...
  
    {
      ...
      heading: "Cooktop Repair in Marina Del Rey",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Marina Del Rey",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>cooktop repair in Marina Del Rey</strong> for gas cooktops,
            electric cooktops, induction cooktops, rangetops, modular cooktops,
            and high-end built-in cooking surfaces. Cooktops in Marina Del Rey homes are often installed into stone countertops,
            custom kitchen islands, coastal remodels, open-concept kitchens,
            condominium kitchens, and designer cooking spaces, so we repair them
            with care for both performance and surrounding finishes.
          </p>
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Marina Del Rey",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Marina Del Rey</strong> for
            ventilation hoods, custom hood inserts, island hoods, wall hoods,
            downdraft systems, and built-in ventilation systems. Proper ventilation is especially important in marina-adjacent homes,
            coastal condos, open-concept kitchens, chef-style cooking spaces, and
            indoor-outdoor entertaining areas where smoke, cooking odors, grease,
            and airflow problems need to be controlled efficiently.
          </p>
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Marina Del Rey",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Marina Del Rey",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Marina Del Rey</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many Marina Del Rey kitchens feature custom cabinetry, concealed appliance
            panels, waterfront condo layouts, built-in refrigeration columns, wine
            storage, beverage centers, and premium appliance suites.
          </p>
  ...
  
    {
      ...
      heading: "Freezer Repair in Marina Del Rey",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Marina Del Rey</strong> for
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Marina Del Rey",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Marina Del Rey",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Marina Del Rey</strong> for
            kitchens, home bars, media rooms, entertainment spaces, guest areas,
            patios, undercounter installations, and custom cabinetry integrations.
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Marina Del Rey",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Marina Del Rey</strong> for
            ...
            patios, outdoor entertaining areas, guest spaces, and coastal homes,
            clear ice production, proper drainage, and quiet operation are all
            important.
          </p>
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Marina Del Rey",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Marina Del Rey</strong> for vented
            dryers, ventless dryers, heat pump dryers, condenser dryers, stacked
            laundry systems, and premium laundry appliances. Dryers in Marina Del Rey homes may be installed in laundry rooms, utility rooms, guest
            spaces, closets, or stacked configurations, so airflow, access, quiet
            operation, and moisture control matter.
          </p>
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Marina Del Rey",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Marina Del Rey",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Marina Del Rey</strong> for
            front-load washers, top-load washers, compact washers, stacked laundry
            systems, and premium laundry appliances. We service laundry systems in coastal homes, condos, laundry rooms, utility
            rooms, guest spaces, closets, and stacked spaces where quiet operation,
            leak prevention, vibration control, and careful access are especially
            important.
          </p>
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Marina Del Rey",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Marina Del Rey</strong> for
            integrated dishwashers, panel-ready dishwashers, drawer dishwashers,
            quiet dishwashers, and high-end built-in models. Many dishwashers in Marina Del Rey homes and condos are installed behind
            custom panels, within open kitchens, butler-style areas, guest spaces,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Marina Del Rey",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Marina Del Rey</strong>{" "}
            for built-in warming drawers, panel-matched drawers, stainless steel
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Marina Del Rey",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Marina Del Rey</strong> for
            ...
            sealing, especially in marina-adjacent homes where coastal humidity, salt-air exposure,
            and installation conditions can affect performance.
          </p>
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Marina Del Rey",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Marina Del Rey",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Marina Del Rey</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, waterfront homes, private tasting areas, and home collections. A
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Marina Del Rey",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Marina Del Rey</strong> for
            ...
            cooking appliances. In Marina Del Rey homes, grill systems may be located in outdoor kitchens,
            patios, rooftop decks, balcony-adjacent entertaining spaces,
            courtyards, marina-view spaces, and custom outdoor living areas where
            reliable ignition, safe gas performance, and even heat are especially
            important.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, grease buildup, weather exposure, salt-air exposure, worn
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Marina Del Rey",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Marina Del Rey",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Marina Del Rey</strong> for indoor
            gourmet kitchens, outdoor kitchens, built-in cooking areas, patios,
            rooftop decks, outdoor entertaining spaces, guest areas, and custom
            outdoor living areas. Pizza ovens require high heat, stable temperature
          ...
          <ul>
            ...
            <li>
              ...
              weather exposure, salt-air exposure, loose components, and high-heat
              wear.
            </li>
          </ul>
        </>
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Marina Del Rey",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Marina Del Rey",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Marina Del Rey</strong>{" "}
            for built-in grills, outdoor refrigerators, beverage centers, ice
            makers, warming drawers, pizza ovens, side burners, outdoor
            ventilation, and premium outdoor cooking systems. Marina Del Rey outdoor kitchens may be part of waterfront patios, rooftop
            decks, courtyards, outdoor dining spaces, pool areas, balcony-adjacent
            entertaining spaces, and custom coastal living areas, so reliable
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, moisture damage, salt-air exposure, grease buildup, wiring
