  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Encino",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Encino",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Encino</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Many Encino homes
            feature large kitchens, custom cabinetry, premium countertops, designer
            finishes, and high-performance cooking appliances, so we approach every
            range repair with careful attention to safety, performance, and the
            surrounding kitchen design.
          </p>
          ...
          <p>
            ...
            while protecting floors, cabinetry, countertops, and built-in
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Encino",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Encino</strong> for wall ovens,
            double ovens, steam ovens, speed ovens, convection ovens, French-door
            ovens, built-in ovens, and oven sections inside premium ranges. Encino
            kitchens often include built-in appliance walls, custom cabinetry,
            panel-matched designs, and luxury cooking suites, so careful diagnosis
            and clean service are essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in Encino",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Encino",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Encino</strong> for
            gas cooktops, electric cooktops, induction cooktops, rangetops,
            modular cooktops, and high-end built-in cooking surfaces. Cooktops in
            Encino homes are often installed into stone countertops, kitchen
            islands, custom cabinetry, or flush-mounted surfaces, so we repair them
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Encino",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Encino</strong> for
            ...
            is especially important in large family kitchens, open-concept homes,
            and outdoor-adjacent cooking spaces where smoke, cooking odors, grease,
  ...
  
    {
      ...
      heading: "Freezer Repair in Encino",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Encino</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Encino",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Encino",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Encino</strong> for kitchens,
            home bars, media rooms, entertainment spaces, guest houses, pool houses,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Encino",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Encino</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In kitchens, home bars, guest houses,
            pool houses, and outdoor entertaining spaces, clear ice production,
            proper drainage, and quiet operation are all important.
          </p>
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Encino",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Encino</strong> for vented dryers,
            ventless dryers, heat pump dryers, condenser dryers, stacked laundry
            systems, and premium laundry appliances. Dryers in Encino homes may be
            installed in laundry rooms, utility closets, garage-adjacent spaces,
            guest houses, or stacked configurations, so airflow, access, quiet
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Encino",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Encino",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Encino</strong> for front-load
            ...
            homes, estate laundry rooms, utility closets, guest houses, and stacked
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Encino",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Encino</strong> for integrated
            dishwashers, panel-ready dishwashers, drawer dishwashers, quiet
            dishwashers, and high-end built-in models. Many dishwashers in Encino
            homes are installed behind custom panels or within designer kitchens,
            so we service them carefully without disturbing the surrounding
            cabinetry.
          </p>
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Encino",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Encino</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Encino",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Encino</strong> for built-in
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Encino",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Encino",
      description: (
        <>
          <p>
            We service <strong>wine cellar cooling systems in Encino</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, estate wine cellars, and private home collections. A wine
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Encino",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Encino</strong> for built-in
            ...
            appliances. In Encino homes, grill systems are often part of patios,
            pool areas, outdoor kitchens, guest houses, and backyard entertaining
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Encino",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Encino",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Encino</strong> for indoor gourmet
            kitchens, outdoor kitchens, built-in cooking areas, patios, poolside
            kitchens, and entertainment spaces. Pizza ovens require high heat,
            stable temperature control, proper ignition, and safe ventilation to
            perform correctly.
          </p>
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Encino",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Encino",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Encino</strong> for
            ...
            premium outdoor cooking systems. Encino outdoor kitchens may be part of
            patios, pool areas, guest houses, backyard entertaining spaces, or
            hillside residences, so reliable appliance performance and careful
            service matter.
          </p>
