...
export const Tabs = () => {
  ...
  heading: "Book Sub-Zero Repair Near You",
      description: (
        ...
        <p>📍 Proudly serving <strong>luxury homes</strong> in <a href="/sub-zero-repair-brentwood/>Brentwood" title="Sub-Zero Repair Brentwood, CA">Brentwood</a>, Bel Air, Beverly Hills, Calabasas, West Hollywood, Santa Monica, Pasadena, San Marino, Pacific Palisades, Malibu, Thousand Oaks and nearby areas</p>
