  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Hollywood",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Hollywood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Hollywood</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Hollywood homes,
            hillside properties, historic residences, condos, apartments, and
            remodeled kitchens often feature premium cooking appliances, custom
            cabinetry, stone countertops, and carefully finished interiors, so we
            approach every range repair with attention to safety, performance, and
            the surrounding kitchen design.
          </p>
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Hollywood",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Hollywood</strong> for wall ovens,
            ...
            Hollywood kitchens often include built-in appliance walls, remodeled
            cabinetry, premium countertops, compact condo layouts, and high-end
            cooking suites, so careful diagnosis and clean service are essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in Hollywood",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Hollywood",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Hollywood</strong>{" "}
            ...
            Hollywood homes are often installed into stone countertops, kitchen
            islands, custom cabinetry, compact condo kitchens, historic remodels,
            or flush-mounted surfaces, so we repair them with care for both
            performance and surrounding finishes.
          </p>
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Hollywood",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Hollywood</strong> for
            ...
            apartments, and open-concept spaces where smoke, cooking odors, grease,
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Hollywood",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Hollywood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Hollywood</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Hollywood kitchens feature refrigerators built into custom cabinetry,
  ...
  
    {
      ...
      heading: "Freezer Repair in Hollywood",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Hollywood</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Hollywood",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Hollywood",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Hollywood</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Hollywood",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Hollywood</strong> for built-in
            ...
            entertainment spaces, guest areas, and remodeled homes, clear ice
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Hollywood",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Hollywood</strong> for vented
            dryers, ventless dryers, heat pump dryers, condenser dryers, stacked
            laundry systems, and premium laundry appliances. Dryers in Hollywood
            may be installed in laundry rooms, utility closets, condos, apartments,
            garage-adjacent spaces, or stacked configurations, so airflow, access,
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Hollywood",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Hollywood",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Hollywood</strong> for front-load
            washers, top-load washers, compact washers, stacked laundry systems,
            and premium laundry appliances. We service laundry systems in homes,
            condos, apartments, utility closets, laundry rooms, and stacked spaces
            where quiet operation, leak prevention, and careful access are
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Hollywood",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Hollywood</strong> for
            ...
            Hollywood homes are installed behind custom panels or within remodeled
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Hollywood",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Hollywood</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Hollywood",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Hollywood</strong> for
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Hollywood",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Hollywood",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Hollywood</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, hillside homes, remodeled residences, entertainment properties,
            and private home collections. A wine cellar cooling system must
            maintain stable temperature, humidity balance, and quiet operation to
            protect wine over time.
          </p>
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Hollywood",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Hollywood</strong> for built-in
            ...
            appliances. In Hollywood homes, grill systems may be located on
            patios, balconies, hillside terraces, pool areas, rooftop spaces, or
            backyard entertaining areas where reliable ignition, safe gas
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Hollywood",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Hollywood",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Hollywood</strong> for indoor
            gourmet kitchens, outdoor kitchens, built-in cooking areas, hillside
            terraces, patios, rooftop spaces, and entertainment areas. Pizza ovens
            require high heat, stable temperature control, proper ignition, and
            safe ventilation to perform correctly.
          </p>
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Hollywood",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Hollywood",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Hollywood</strong> for
            ...
            premium outdoor cooking systems. Hollywood outdoor kitchens may be part
            of patios, hillside homes, terraces, rooftop spaces, pool areas,
            backyard entertaining spaces, or custom outdoor living areas, so
