  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in San Marino",
      img: "/cities/range-repair.webp",
      alt: "Range repair in San Marino",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in San Marino</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. San Marino homes
            often feature custom kitchens, historic residences, architect-designed homes,
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in San Marino",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>oven repair in San Marino</strong> for wall ovens,
            ...
            San Marino homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in San Marino",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in San Marino",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in San Marino</strong>{" "}
            ...
            San Marino kitchens are often designed with stone countertops, custom
            islands, flush-mounted surfaces, and carefully integrated layouts in historic
            and renovated homes. We repair cooktops with care for both performance and
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in San Marino",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in San Marino</strong> for
            ...
            is especially important in San Marino kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in San Marino",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in San Marino",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in San Marino</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            San Marino homes feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in San Marino",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in San Marino</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in San Marino",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in San Marino",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in San Marino</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in San Marino",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in San Marino</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In San Marino kitchens, home bars,
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in San Marino",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in San Marino</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in San Marino",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in San Marino",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in San Marino</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in San Marino",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in San Marino</strong> for
            ...
            dishwashers in San Marino kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in San Marino",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in San Marino</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in San Marino",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in San Marino</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in San Marino",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in San Marino",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in San Marino</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in San Marino",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in San Marino</strong> for built-in
            ...
            appliances. Many San Marino homes include patios, terraces, poolside
            entertaining spaces, landscaped backyards, and built-in grilling stations
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in San Marino",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in San Marino",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in San Marino</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in San Marino",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in San Marino",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in San Marino</strong> for
            ...
            premium backyard cooking systems. San Marino outdoor kitchens are often
            designed for patios, terraces, pool areas, landscaped backyards, family
