  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Playa del Rey",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Playa del Rey",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Playa del Rey</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Playa del Rey homes
            often feature custom kitchens, coastal residences, open-concept layouts,
            stone countertops, premium ventilation, and built-in appliance suites, so we approach every range repair with attention to safety,
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Playa del Rey",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Playa del Rey</strong> for wall ovens,
            ...
            Playa del Rey homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Playa del Rey",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Playa del Rey",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Playa del Rey</strong>{" "}
            ...
            Playa del Rey kitchens are often designed with stone countertops, custom
            islands, flush-mounted surfaces, and open-concept layouts that connect
            indoor cooking spaces with entertaining areas. We repair cooktops with
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Playa del Rey",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Playa del Rey</strong> for
            ...
            is especially important in Playa del Rey kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Playa del Rey",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Playa del Rey",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Playa del Rey</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Playa del Rey homes feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in Playa del Rey",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Playa del Rey</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Playa del Rey",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Playa del Rey",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Playa del Rey</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Playa del Rey",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Playa del Rey</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Playa del Rey kitchens, home bars,
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Playa del Rey",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Playa del Rey</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Playa del Rey",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Playa del Rey",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Playa del Rey</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Playa del Rey",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Playa del Rey</strong> for
            ...
            dishwashers in Playa del Rey kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Playa del Rey",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Playa del Rey</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Playa del Rey",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Playa del Rey</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Playa del Rey",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Playa del Rey",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Playa del Rey</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Playa del Rey",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Playa del Rey</strong> for built-in
            ...
            appliances. Many Playa del Rey homes include patios, rooftop decks,
            outdoor entertaining spaces, coastal residences, and built-in grilling
            stations that require reliable ignition, even heat, and safe gas
            performance. Outdoor components may also need closer inspection for
            moisture exposure and coastal corrosion.
          </p>
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Playa del Rey",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Playa del Rey",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Playa del Rey</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Playa del Rey",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Playa del Rey",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Playa del Rey</strong> for
            ...
            premium backyard cooking systems. Playa del Rey outdoor kitchens are often
            designed for patios, rooftop decks, coastal homes, family gatherings, and
            indoor-outdoor entertaining spaces. Reliable appliance performance,
            careful service, and inspection for moisture or coastal corrosion all
            matter.
          </p>
