  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Malibu",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Malibu",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Malibu</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Malibu homes often
            feature ocean-view kitchens, custom cabinetry, stone countertops,
            indoor-outdoor layouts, designer finishes, and premium cooking
            appliances, so we approach every range repair with attention to safety,
            performance, and the surrounding kitchen design.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              cabinetry, stone countertops, designer floors, oceanfront home
              layouts, built-in range installations, and high-end kitchen finishes.
            </li>
          </ul>
        </>
      ),
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Malibu",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Malibu</strong> for wall ovens,
            double ovens, steam ovens, speed ovens, convection ovens, French-door
            ovens, built-in ovens, and oven sections inside premium ranges. Malibu
            kitchens often include custom appliance walls, open entertaining
            layouts, designer cabinetry, stone surfaces, and high-end appliance
            suites, so careful diagnosis and clean service are essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in Malibu",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Malibu",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Malibu</strong> for
            gas cooktops, electric cooktops, induction cooktops, rangetops, modular
            cooktops, and high-end built-in cooking surfaces. Cooktops in Malibu
            homes are often installed into stone countertops, custom kitchen
            islands, open-concept kitchens, ocean-view remodels, and designer
            cooking spaces, so we repair them with care for both performance and
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Malibu",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Malibu</strong> for
            ...
            is especially important in oceanfront homes, open-concept kitchens,
            chef-style cooking spaces, and indoor-outdoor entertaining areas where
            smoke, cooking odors, grease, and airflow problems need to be
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Malibu",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Malibu",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Malibu</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Malibu kitchens feature custom cabinetry, concealed appliance panels,
            ocean-view layouts, built-in refrigeration columns, wine storage,
            beverage centers, and premium appliance suites.
          </p>
  ...
  
    {
      ...
      heading: "Freezer Repair in Malibu",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Malibu</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Malibu",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Malibu",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Malibu</strong> for kitchens,
            home bars, media rooms, entertainment spaces, guest houses, pool areas,
            undercounter installations, and custom cabinetry integrations. Beverage
            centers may look simple, but they rely on precise temperature control,
            quiet operation, proper airflow, and clean integration with cabinetry.
          </p>
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Malibu",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Malibu</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In kitchens, home bars, pool houses,
            outdoor entertaining areas, guest houses, and oceanfront homes, clear
            ice production, proper drainage, and quiet operation are all important.
          </p>
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Malibu",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Malibu</strong> for vented dryers,
            ventless dryers, heat pump dryers, condenser dryers, stacked laundry
            systems, and premium laundry appliances. Dryers in Malibu homes may be
            installed in laundry rooms, utility rooms, guest houses, closets, or
            stacked configurations, so airflow, access, quiet operation, and
            moisture control matter.
          </p>
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Malibu",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Malibu",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Malibu</strong> for front-load
            washers, top-load washers, compact washers, stacked laundry systems,
            and premium laundry appliances. We service laundry systems in coastal
            homes, estate laundry rooms, utility rooms, guest houses, closets, and
            stacked spaces where quiet operation, leak prevention, and careful
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Malibu",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Malibu</strong> for integrated
            dishwashers, panel-ready dishwashers, drawer dishwashers, quiet
            dishwashers, and high-end built-in models. Many dishwashers in Malibu
            homes are installed behind custom panels, within open kitchens,
            butler’s pantries, guest kitchens, or entertaining areas, so we service
            them carefully without disturbing the surrounding cabinetry.
          </p>
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Malibu",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Malibu</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Malibu",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Malibu</strong> for built-in
            wine coolers, undercounter wine refrigerators, dual-zone wine units,
            column wine storage, and panel-ready wine preservation systems. Wine
            coolers require more than basic cooling — they need stable temperature,
            controlled vibration, proper airflow, and reliable door sealing,
            especially in coastal homes where humidity and installation conditions
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Malibu",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Malibu",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Malibu</strong> for residential
            wine rooms, climate-controlled wine storage, custom wine spaces,
            oceanfront estates, hillside homes, private tasting rooms, and home
            collections. A wine cellar cooling system must maintain stable
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Malibu",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Malibu</strong> for built-in
            ...
            appliances. In Malibu homes, grill systems may be located in outdoor
            kitchens, pool areas, patios, ocean-view terraces, guest house spaces,
            and large entertaining areas where reliable ignition, safe gas
            performance, and even heat are especially important.
          </p>
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Malibu",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Malibu",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Malibu</strong> for indoor gourmet
            kitchens, outdoor kitchens, built-in cooking areas, patios, poolside
            kitchens, ocean-view terraces, guest house kitchens, and entertainment
            spaces. Pizza ovens require high heat, stable temperature control,
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Malibu",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Malibu",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Malibu</strong> for
            ...
            premium outdoor cooking systems. Malibu outdoor kitchens may be part of
            oceanfront patios, pool areas, terraces, guest houses, hillside
