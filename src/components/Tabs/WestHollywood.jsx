  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in West Hollywood",
      img: "/cities/range-repair.webp",
      alt: "Range repair in West Hollywood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in West Hollywood</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. West Hollywood residences
            often feature designer kitchens, luxury condos, contemporary homes,
            renovated properties, stone countertops, premium ventilation, and
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in West Hollywood",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>oven repair in West Hollywood</strong> for wall ovens,
            ...
            West Hollywood residences, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in West Hollywood",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in West Hollywood",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in West Hollywood</strong>{" "}
            ...
            West Hollywood kitchens are often designed with stone countertops, custom
            islands, flush-mounted surfaces, and space-conscious layouts in luxury
            condos, contemporary homes, and renovated residences. We repair cooktops with
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in West Hollywood",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in West Hollywood</strong> for
            ...
            is especially important in West Hollywood kitchens with powerful gas
            ranges, pro-style burners, grills, griddles, high-BTU cooking equipment,
            open-concept layouts, and indoor-outdoor entertaining spaces.
          </p>
  ...
  
    {
      ...
      heading: "Refrigerator Repair in West Hollywood",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in West Hollywood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in West Hollywood</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            West Hollywood residences feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in West Hollywood",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in West Hollywood</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in West Hollywood",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in West Hollywood",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in West Hollywood</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in West Hollywood",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in West Hollywood</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In West Hollywood kitchens, home bars,
            entertainment rooms, patios, rooftop spaces, and guest areas, reliable ice
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in West Hollywood",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in West Hollywood</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in West Hollywood",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in West Hollywood",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in West Hollywood</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in West Hollywood",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in West Hollywood</strong> for
            ...
            dishwashers in West Hollywood kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in West Hollywood",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in West Hollywood</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in West Hollywood",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in West Hollywood</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in West Hollywood",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in West Hollywood",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in West Hollywood</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in West Hollywood",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in West Hollywood</strong> for built-in
            ...
            appliances. Many West Hollywood residences include patios, terraces, rooftop
            entertaining areas, private courtyards, and built-in grilling stations
            that require reliable ignition, even heat, and safe gas performance.
            Outdoor components may also need closer inspection for weather exposure,
            heat, moisture, dust, and seasonal wear.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, grease buildup, weather exposure, moisture-related wear,
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in West Hollywood",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in West Hollywood",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in West Hollywood</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in West Hollywood",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in West Hollywood",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in West Hollywood</strong> for
            ...
            premium outdoor cooking systems. West Hollywood outdoor kitchens are often
            designed for patios, terraces, rooftop entertaining areas, private
            courtyards, and indoor-outdoor gathering spaces. Reliable appliance
            performance, careful service, and inspection for weather-related wear
            all matter.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, moisture damage, heat exposure, grease buildup, wiring
              problems, and worn outdoor components.
            </li>
          </ul>
        </>
      ),
