  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Westwood",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Westwood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Westwood</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Westwood residences
            often feature custom kitchens, luxury condos along the Wilshire Corridor,
            remodeled single-family homes, townhomes, stone countertops, premium
            ventilation, and built-in appliance suites, so we approach every range repair with attention to safety,
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Westwood",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Westwood</strong> for wall ovens,
            ...
            Westwood residences, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Westwood",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Westwood",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Westwood</strong>{" "}
            ...
            Westwood kitchens are often designed with stone countertops, custom
            islands, flush-mounted surfaces, and carefully planned layouts in luxury
            condos, townhomes, and remodeled residences. We repair cooktops with
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Westwood",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Westwood</strong> for
            ...
            is especially important in Westwood kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Westwood",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Westwood",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Westwood</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Westwood residences feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in Westwood",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Westwood</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Westwood",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Westwood",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Westwood</strong> for kitchens,
            home bars, entertainment rooms, guest areas, patios,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Westwood",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Westwood</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Westwood kitchens, home bars,
            entertainment rooms, patios, and guest areas, reliable ice
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Westwood",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Westwood</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Westwood",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Westwood",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Westwood</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Westwood",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Westwood</strong> for
            ...
            dishwashers in Westwood kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Westwood",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Westwood</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Westwood",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Westwood</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Westwood",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Westwood",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Westwood</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Westwood",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Westwood</strong> for built-in
            ...
            appliances. Many Westwood residences include patios, terraces, private courtyards,
            landscaped backyard entertaining areas, and built-in grilling stations
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Westwood",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Westwood",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Westwood</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Westwood",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Westwood",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Westwood</strong> for
            ...
            premium outdoor cooking systems. Westwood outdoor kitchens are often
            designed for patios, terraces, private courtyards, landscaped backyards,
            and indoor-outdoor gathering spaces. Reliable appliance
