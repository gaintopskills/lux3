  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in La Cañada Flintridge",
      img: "/cities/range-repair.webp",
      alt: "Range repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in La Cañada Flintridge</strong> for gas ranges,
            dual-fuel ranges, electric ranges, induction ranges, European ranges,
            retro ranges, and professional-style cooking appliances. La Cañada
            Flintridge homes often feature spacious kitchens, custom cabinetry,
            stone countertops, premium cooking appliances, family entertaining
            spaces, and carefully finished interiors, so we approach every range
            repair with attention to safety, performance, and the surrounding
            kitchen design.
          </p>
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in La Cañada Flintridge",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>oven repair in La Cañada Flintridge</strong> for
            wall ovens, double ovens, steam ovens, speed ovens, convection ovens,
            French-door ovens, built-in ovens, and oven sections inside premium
            ranges. La Cañada Flintridge kitchens often include built-in appliance
            walls, custom millwork, large family cooking spaces, premium
            countertops, and high-end appliance suites, so careful diagnosis and
            clean service are essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in La Cañada Flintridge",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>cooktop repair in La Cañada Flintridge</strong> for gas
            cooktops, electric cooktops, induction cooktops, rangetops, modular
            cooktops, and high-end built-in cooking surfaces. Cooktops in La
            Cañada Flintridge homes are often installed into stone countertops,
            custom islands, flush-mounted surfaces, family kitchens, and designer
            remodels, so we repair them with care for both performance and
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in La Cañada Flintridge",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide{" "}
            <strong>range hood repair in La Cañada Flintridge</strong> for
            ...
            is especially important in open-concept kitchens, foothill homes,
            family cooking spaces, outdoor-adjacent kitchens, and high-end remodels
  ...
  
    {
      ...
      heading: "Refrigerator Repair in La Cañada Flintridge",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in La Cañada Flintridge</strong> for
            built-in, panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many La
            Cañada Flintridge kitchens feature refrigerators built into custom
            cabinetry, concealed behind matching panels, or paired with freezer
            columns, beverage centers, and wine storage, so we repair them carefully
            while protecting surrounding finishes.
          </p>
  ...
  
    {
      ...
      heading: "Freezer Repair in La Cañada Flintridge",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in La Cañada Flintridge</strong> for
  ...
  
    {
      ...
      heading: "Beverage Center Repair in La Cañada Flintridge",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in La Cañada Flintridge</strong> for
            kitchens, home bars, media rooms, entertainment spaces, guest houses,
            pool areas, undercounter installations, and custom cabinetry
            integrations. Beverage centers may look simple, but they rely on
            precise temperature control, quiet operation, proper airflow, and clean
  ...
  
    {
      ...
      heading: "Ice Maker Repair in La Cañada Flintridge",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in La Cañada Flintridge</strong>{" "}
            for built-in ice machines, undercounter ice makers, panel-ready ice
            machines, and refrigerator ice maker systems. In kitchens, home bars,
            pool areas, outdoor entertaining spaces, guest houses, and family
            entertainment rooms, clear ice production, proper drainage, and quiet
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in La Cañada Flintridge",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in La Cañada Flintridge</strong> for
            vented dryers, ventless dryers, heat pump dryers, condenser dryers,
            stacked laundry systems, and premium laundry appliances. Dryers in La
            Cañada Flintridge homes may be installed in laundry rooms, utility
            rooms, guest houses, closets, garage-adjacent areas, or stacked
            configurations, so airflow, access, quiet operation, and moisture
            control matter.
          </p>
  ...
  
    {
      ...
      heading: "Washing Machine Repair in La Cañada Flintridge",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in La Cañada Flintridge</strong> for
            front-load washers, top-load washers, compact washers, stacked laundry
            systems, and premium laundry appliances. We service laundry systems in
            family laundry rooms, utility rooms, guest houses, closets, and stacked
  ...
  
    {
      ...
      heading: "Dishwasher Repair in La Cañada Flintridge",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in La Cañada Flintridge</strong>{" "}
            for integrated dishwashers, panel-ready dishwashers, drawer
            dishwashers, quiet dishwashers, and high-end built-in models. Many
            dishwashers in La Cañada Flintridge homes are installed behind custom
            panels, within large family kitchens, butler’s pantries, guest spaces,
            or entertaining areas, so we service them carefully without disturbing
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in La Cañada Flintridge",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide{" "}
            <strong>warming drawer repair in La Cañada Flintridge</strong> for
          ...
          <ul>
            <li>
              <strong>Heating system testing:</strong> We inspect heating elements,
              thermostats, relays, wiring, and control output.
            </li>
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in La Cañada Flintridge",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in La Cañada Flintridge</strong>{" "}
            for built-in wine coolers, undercounter wine refrigerators, dual-zone
            wine units, column wine storage, and panel-ready wine preservation
            systems. Wine coolers require more than basic cooling — they need
            stable temperature, controlled vibration, proper airflow, and reliable
            door sealing.
          </p>
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in La Cañada Flintridge",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in La Cañada Flintridge</strong>{" "}
            for residential wine rooms, climate-controlled wine storage, custom
            wine spaces, private collections, foothill homes, and dedicated wine
            storage areas. A wine cellar cooling system must maintain stable
            temperature, humidity balance, and quiet operation to protect wine over
            time.
          </p>
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in La Cañada Flintridge",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in La Cañada Flintridge</strong>{" "}
            for built-in grills, outdoor kitchen grills, pro-style gas grills,
            freestanding grills, sear stations, rotisserie systems, and outdoor
            cooking appliances. In La Cañada Flintridge homes, grill systems may be
            located in outdoor kitchens, patios, pool areas, backyard entertaining
            spaces, guest house areas, or foothill terraces where reliable
            ignition, safe gas performance, and even heat are especially important.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Outdoor condition assessment:</strong> We look for corrosion,
              grease buildup, weather exposure, worn components, and maintenance
              needs.
            </li>
          </ul>
        </>
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in La Cañada Flintridge",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in La Cañada Flintridge</strong> for
            indoor gourmet kitchens, outdoor kitchens, built-in cooking areas,
            patios, poolside kitchens, backyard entertaining spaces, and foothill
            homes. Pizza ovens require high heat, stable temperature control,
            proper ignition, and safe ventilation to perform correctly.
          </p>
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in La Cañada Flintridge",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in La Cañada Flintridge",
      description: (
        <>
          <p>
            We provide{" "}
            <strong>outdoor kitchen repair in La Cañada Flintridge</strong> for
            ...
            premium outdoor cooking systems. La Cañada Flintridge outdoor kitchens
            may be part of pool areas, patios, backyard entertaining spaces,
            foothill terraces, guest houses, and custom outdoor living areas, so
            reliable appliance performance and careful service matter.
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              corrosion, moisture damage, grease buildup, wiring problems, and worn
              outdoor components.
            </li>
          </ul>
        </>
