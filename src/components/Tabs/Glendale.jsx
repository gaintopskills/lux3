  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Glendale",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Glendale",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Glendale</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Glendale homes,
            hillside properties, townhomes, condos, and remodeled kitchens often
            feature premium cooking appliances, custom cabinetry, stone countertops,
            and carefully finished interiors, so we approach every range repair with
            attention to safety, performance, and the surrounding kitchen design.
          </p>
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Glendale",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Glendale</strong> for wall ovens,
            double ovens, steam ovens, speed ovens, convection ovens, French-door
            ovens, built-in ovens, and oven sections inside premium ranges.
            Glendale kitchens often include built-in appliance walls, remodeled
            cabinetry, premium countertops, and high-end cooking suites, so careful
            diagnosis and clean service are essential.
          </p>
  ...
  
    {
      ...
      heading: "Cooktop Repair in Glendale",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Glendale",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Glendale</strong> for
            gas cooktops, electric cooktops, induction cooktops, rangetops, modular
            cooktops, and high-end built-in cooking surfaces. Cooktops in Glendale
            homes are often installed into stone countertops, kitchen islands,
            custom cabinetry, compact condo kitchens, or flush-mounted surfaces, so
            we repair them with care for both performance and surrounding finishes.
          </p>
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Glendale",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Glendale</strong> for
            ...
            is especially important in remodeled kitchens, hillside homes, condos,
            and open-concept spaces where smoke, cooking odors, grease, and airflow
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Glendale",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Glendale",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Glendale</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Glendale kitchens feature refrigerators built into custom cabinetry,
            placed in compact condo layouts, or concealed behind matching panels,
            so we repair them carefully while protecting surrounding finishes.
          </p>
  ...
  
    {
      ...
      heading: "Freezer Repair in Glendale",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Glendale</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Glendale",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Glendale",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Glendale</strong> for kitchens,
            home bars, media rooms, entertainment spaces, offices, undercounter
            installations, guest spaces, and remodeled kitchens. Beverage centers
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Glendale",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Glendale</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In kitchens, home bars, offices,
            entertainment spaces, and remodeled homes, clear ice production, proper
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Glendale",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Glendale</strong> for vented dryers,
            ventless dryers, heat pump dryers, condenser dryers, stacked laundry
            systems, and premium laundry appliances. Dryers in Glendale may be
            installed in laundry rooms, utility closets, condos, garage-adjacent
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Glendale",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Glendale",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Glendale</strong> for front-load
            washers, top-load washers, compact washers, stacked laundry systems,
            and premium laundry appliances. We service laundry systems in family
            homes, condos, utility closets, laundry rooms, and stacked spaces where
            quiet operation, leak prevention, and careful access are especially
            important.
          </p>
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Glendale",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Glendale</strong> for
            ...
            Glendale homes are installed behind custom panels or within remodeled
            kitchens, so we service them carefully without disturbing the
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Glendale",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Glendale</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Glendale",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Glendale</strong> for built-in
  ...
  
    {
      ...
      heading: "Wine Cellar Cooling System Repair in Glendale",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine cellar cooling system repair in Glendale",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine cellar cooling systems in Glendale</strong> for
            residential wine rooms, climate-controlled wine storage, custom wine
            spaces, hillside homes, remodeled residences, and private home
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Glendale",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Glendale</strong> for built-in
            ...
            appliances. In Glendale homes, grill systems may be located on patios,
            balconies, hillside terraces, pool areas, or backyard entertaining
            spaces where reliable ignition, safe gas performance, and even heat are
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Glendale",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Glendale",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Glendale</strong> for indoor gourmet
            kitchens, outdoor kitchens, built-in cooking areas, hillside terraces,
            patios, and entertainment spaces. Pizza ovens require high heat, stable
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Glendale",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Glendale",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Glendale</strong> for
            ...
            premium outdoor cooking systems. Glendale outdoor kitchens may be part
            of patios, hillside homes, terraces, pool areas, backyard entertaining
            spaces, or custom outdoor living areas, so reliable appliance
