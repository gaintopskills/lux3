...
export const Tabs = () => {
  ...
  const items = [
    ...
    {
          id: "hestan-outdoor-refrigeration-repair",
          title: "Hestan Outdoor Refrigeration Repair",
          heading: "Hestan Outdoor Refrigeration Repair",
          alt: "Hestan outdoor refrigeration repair technician servicing an undercounter refrigerator",
          description: (
            <>
              <p>
                We service <strong>Hestan Outdoor refrigeration repair</strong> for undercounter refrigerators, glass-door refrigerators, refrigerator drawers, dual-zone refrigerator and wine storage, refrigerator/freezer drawers, beer dispensers, and outdoor ice machines. Hestan indoor appliances are mainly cooking-focused, so this tab is specifically for Hestan Outdoor refrigeration products.
              </p>
    
              <h3>Hestan Outdoor Refrigeration Issues We Diagnose</h3>
              <ul>
                <li>Outdoor refrigerator not cooling in hot weather because of condenser restriction, blocked ventilation, failed condenser fan, or high ambient load.</li>
                <li>Refrigerator drawers warming or sweating due to drawer alignment, gasket wear, overloading, or humidity exposure.</li>
                <li>Dual-zone refrigerator/wine storage not holding separate zones because of fan, sensor, control, or glass-door heat load.</li>
                <li>Beer dispenser not chilling properly due to thermostat, airflow, sealed-system, or line temperature problems.</li>
                <li>Outdoor ice machine not producing or draining correctly because of scale, water supply, pump, drain, bin sensor, or ambient heat issues.</li>
              </ul>
    
              <h3>Technician Approach for Hestan Outdoor</h3>
              <p>
                We diagnose Hestan Outdoor refrigeration by checking ambient conditions, enclosure ventilation, condenser cleanliness, fan operation, compressor performance, temperature sensors, drawer seals, door alignment, drains, and water supply. Outdoor refrigeration failures are often caused by heat rejection and exposure, so we test the installation as carefully as the appliance.
              </p>
            </>
          )
        },
    ...
    {
          id: "caliber-outdoor-refrigeration-repair",
          title: "Caliber Outdoor Refrigeration Repair",
          heading: "Caliber Outdoor Refrigeration Repair",
          alt: "Caliber outdoor refrigeration repair technician servicing an outdoor kitchen refrigerator",
          description: (
            <>
              <p>
                We provide <strong>Caliber outdoor refrigeration repair</strong> for Caliber and True Caliber outdoor kitchen refrigeration installations, including outdoor-rated refrigerators, beverage centers, refrigerator drawers, ice machines, wine storage, and refrigeration used alongside Caliber outdoor grills and griddles. Because True Caliber combines outdoor cooking with premium refrigeration, service has to consider both the appliance and the outdoor kitchen enclosure.
              </p>
    
              <h3>Caliber Outdoor Refrigeration Issues We Diagnose</h3>
              <ul>
                <li>Outdoor refrigerator not cooling in warm weather because of blocked front ventilation, direct sun exposure, condenser debris, weak fans, or an overloaded compressor.</li>
                <li>Beverage center or wine unit temperature swings caused by glass door heat gain, damaged gaskets, failed sensors, or poor airflow around the cabinet.</li>
                <li>Refrigerator drawers not sealing evenly because of drawer alignment, slide wear, gasket compression, or cabinet installation pressure.</li>
                <li>Ice machine slow production, water leaks, scale buildup, drain problems, or pump issues common in outdoor bar installations.</li>
                <li>Corrosion, moisture intrusion, control failure, or wiring issues caused by weather exposure, coastal air, irrigation overspray, or improper enclosure design.</li>
              </ul>
    
              <h3>Technician Approach for Caliber</h3>
              <p>
                For Caliber and True Caliber outdoor refrigeration, we start with the environment. We check whether the unit has correct ventilation, shade, drainage, clearance, and electrical protection before condemning sealed-system parts. Then we inspect condenser cleanliness, fan operation, thermostat or sensor accuracy, gasket compression, drawer alignment, ice-machine water supply, drain routing, and corrosion-prone areas. Outdoor refrigeration must be diagnosed under real heat-load conditions because a unit that seems fine in the morning can fail during afternoon sun or heavy entertaining use.
              </p>
            </>
          )
        },
