  ...
  const items = [
    {
      id: "range",
      title: "Range Repair",
      heading: "Range Repair in Pasadena",
      img: "/cities/range-repair.webp",
      alt: "Range repair in Pasadena",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides professional{" "}
            <strong>range repair in Pasadena</strong> for gas ranges, dual-fuel
            ranges, electric ranges, induction ranges, European ranges, retro
            ranges, and professional-style cooking appliances. Pasadena homes
            often feature custom kitchens, historic residences, hillside properties,
            architect-designed homes, stone countertops, premium ventilation, and
  ...
  
    {
      id: "oven",
      title: "Oven Repair",
      heading: "Oven Repair in Pasadena",
      img: "/cities/oven-repair.webp",
      alt: "Oven repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>oven repair in Pasadena</strong> for wall ovens,
            ...
            Pasadena homes, ovens are often integrated into custom cabinetry or
  ...
  
    {
      ...
      heading: "Cooktop Repair in Pasadena",
      img: "/cities/cooktop-repair.webp",
      alt: "Cooktop repair in Pasadena",
      description: (
        <>
          <p>
            Our technicians provide <strong>cooktop repair in Pasadena</strong>{" "}
            ...
            Pasadena kitchens are often designed with stone countertops, custom
  ...
  
    {
      ...
      heading: "Ventilation & Range Hood Repair in Pasadena",
      img: "/cities/range-hood-repair.webp",
      alt: "Ventilation and range hood repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>range hood repair in Pasadena</strong> for
            ...
            is especially important in Pasadena kitchens with powerful gas
  ...
  
    {
      ...
      heading: "Refrigerator Repair in Pasadena",
      img: "/cities/refrigerator-repair.webp",
      alt: "Refrigerator repair in Pasadena",
      description: (
        <>
          <p>
            Luxury Appliance Repair by Zaricci provides{" "}
            <strong>refrigerator repair in Pasadena</strong> for built-in,
            panel-ready, integrated, column, French door, bottom freezer,
            side-by-side, and high-end residential refrigeration systems. Many
            Pasadena homes feature refrigerators built into custom cabinetry or
  ...
  
    {
      ...
      heading: "Freezer Repair in Pasadena",
      img: "/cities/freezer-repair.webp",
      alt: "Freezer repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>freezer repair in Pasadena</strong> for built-in
  ...
  
    {
      ...
      heading: "Beverage Center Repair in Pasadena",
      img: "/cities/beverage-center-repair.webp",
      alt: "Beverage center repair in Pasadena",
      description: (
        <>
          <p>
            We repair <strong>beverage centers in Pasadena</strong> for kitchens,
  ...
  
    {
      ...
      heading: "Ice Maker Repair in Pasadena",
      img: "/cities/ice-maker-repair.webp",
      alt: "Ice maker repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>ice maker repair in Pasadena</strong> for built-in
            ice machines, undercounter ice makers, panel-ready ice machines, and
            refrigerator ice maker systems. In Pasadena kitchens, home bars,
  ...
  
    {
      id: "dryer",
      title: "Dryer Repair",
      heading: "Dryer Repair in Pasadena",
      img: "/cities/dryer-repair.webp",
      alt: "Dryer repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>dryer repair in Pasadena</strong> for vented
  ...
  
    {
      ...
      heading: "Washing Machine Repair in Pasadena",
      img: "/cities/washing-machine-repair.webp",
      alt: "Washing machine repair in Pasadena",
      description: (
        <>
          <p>
            Our technicians provide{" "}
            <strong>washing machine repair in Pasadena</strong> for front-load
  ...
  
    {
      ...
      heading: "Dishwasher Repair in Pasadena",
      img: "/cities/dishwasher-repair.webp",
      alt: "Dishwasher repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>dishwasher repair in Pasadena</strong> for
            ...
            dishwashers in Pasadena kitchens are hidden behind custom cabinetry,
  ...
  
    {
      ...
      heading: "Warming Drawer Repair in Pasadena",
      img: "/cities/warming-drawer-repair.webp",
      alt: "Warming drawer repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>warming drawer repair in Pasadena</strong> for
  ...
  
    {
      ...
      heading: "Wine Cooler Repair in Pasadena",
      img: "/cities/wine-cooler-repair.webp",
      alt: "Wine cooler repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>wine cooler repair in Pasadena</strong> for
  ...
  
    {
      ...
      heading: "Wine Storage & Preservation System Repair in Pasadena",
      img: "/cities/wine-cellar-repair.webp",
      alt: "Wine storage and preservation system repair in Pasadena",
      description: (
        <>
          <p>
            We service{" "}
            <strong>wine storage and preservation systems in Pasadena</strong> for
  ...
  
    {
      ...
      heading: "BBQ Grill Repair in Pasadena",
      img: "/cities/bbq-grill-repair.webp",
      alt: "BBQ grill repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>BBQ grill repair in Pasadena</strong> for built-in
            ...
            appliances. Many Pasadena homes include patios, terraces, poolside
  ...
  
    {
      ...
      heading: "Pizza Oven Repair in Pasadena",
      img: "/cities/pizza-oven-repair.webp",
      alt: "Pizza oven repair in Pasadena",
      description: (
        <>
          <p>
            We service <strong>pizza ovens in Pasadena</strong> for indoor
  ...
  
    {
      ...
      heading: "Outdoor Kitchen Repair in Pasadena",
      img: "/cities/outdoor-kitchen-repair.webp",
      alt: "Outdoor kitchen appliance repair in Pasadena",
      description: (
        <>
          <p>
            We provide <strong>outdoor kitchen repair in Pasadena</strong> for
            ...
            premium backyard cooking systems. Pasadena outdoor kitchens are often
